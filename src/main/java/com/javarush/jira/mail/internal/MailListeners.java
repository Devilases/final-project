...
public class MailListeners {
    ...
    public void confirmRegistration(RegistrationConfirmEvent event) {
        ...
        mailService.sendToUserAsync("email-confirmation-en.html", user, Map.of("confirmationUrl", confirmationUrl));
    }
    ...
    public void resetPassword(PasswordResetEvent event) {
        ...
        mailService.sendToUserAsync("password-reset-en.html", event.user(), Map.of("resetUrl", resetUrl));
    }
}
